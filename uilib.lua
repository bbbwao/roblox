game.StarterGui:SetCore("SendNotification", {
    Title = "Made DiaPhu-Hub";
    Text = "CHOI GAME MA HACK VAY BA!";
    Duration = 5;
})
warn('===============================')
warn('Welcome to KeyDiaPhu  !')
warn('Version: 5.0.0')
warn('Status: online')
warn('Good Game')
warn('===============================')
...
Instructions.Size = UDim2.new(0.4, 0, 0, 80)
Instructions.Position = UDim2.new(0, 0, 0.2, 0)
Instructions.Text = "KEY:"
...
TextBox.PlaceholderText = "VD:DP_xxxxxxxxxxxxxxxxxxxxxx"
TextBox.Text = ""
TextBox.TextSize = 12
...
CheckKey.Size = UDim2.new(0.25, 0, 0.15, 0)
CheckKey.Position = UDim2.new(0.35, 0.5, 0.7, 0.5)
...
CheckKey.MouseButton1Click:Connect(function()
    ...
    if validateKey(enteredKey) then
        TextBox.PlaceholderText = "Thành Công!"
        TextBox.Text = ""
        wait(1)
        ScreenGui:Destroy()
